  ...
  constructor() {
    ...
    this.topSeries = {
      titles: [
        {
          number: 1,
          image: { src: 'assets/Top10/1-papel.webp', alt: 'La casa de papel' },
        },
        {
          number: 2,
          image: { src: 'assets/Top10/2-reina.webp', alt: 'La reina del flow' },
        },
        {
          number: 3,
          image: { src: 'assets/Top10/3-titanes.webp', alt: 'Titanes' },
        },
        {
          number: 4,
          image: {
        ...
        {
          number: 7,
          image: { src: 'assets/Top10/7-blacklist.webp', alt: 'Blacklist' },
        },
        {
          number: 8,
          image: { src: 'assets/Top10/8-ricos.webp', alt: 'Ricos y mimados' },
        },
        {
          number: 9,
          image: {
...
function filmDuration(): number {
  return Math.floor(Math.random() * (210 - 120) + 120);
}
